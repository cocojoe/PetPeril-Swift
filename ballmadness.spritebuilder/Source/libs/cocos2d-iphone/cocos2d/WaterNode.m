...
-(void)onEnter
{
    ...
    //[[CCTextureCache sharedTextureCache] textureForKey:@"World Mountain/background_sky.png"];
    
	// Set the cave background texture.
	self.shaderUniforms[@"refractedBackground"] = [[CCTextureCache sharedTextureCache] textureForKey:@"World Mountain/background_sky.png"];
	
	CCTexture *noise = [CCTexture textureWithFile:@"World Mountain/noise.png"];
